...
import com.wangy.scan.utils.ActionUtils;
import com.wangy.scan.utils.QrUtils;
import com.wangy.scan.zxing.camera.CameraManager;
import com.wangy.scan.zxing.decoding.CaptureActivityHandler;
import com.wangy.scan.zxing.decoding.InactivityTimer;
import com.wangy.scan.zxing.view.ViewfinderView;
...
//                {
//                    Bitmap myBitmap = BitmapHelper.getSmallBitmap(list.get(0));
//                    String resultZxing = new DecodeUtils(DecodeUtils.DECODE_DATA_MODE_ALL)
//                            .decodeWithZxing(myBitmap);
//                    String resultZbar = new DecodeUtils(DecodeUtils.DECODE_DATA_MODE_ALL)
//                            .decodeWithZbar(myBitmap);
//
//                    if (!CommonUtils.isEmpty(resultZbar)) {
//                        Intent intent = new Intent();
//                        intent.putExtra(JsMethodAdapter.CODE, resultZbar);
//                        setResult(RESULT_OK, intent);
//                        finish();
//                    } else if (!CommonUtils.isEmpty(resultZxing)) {
//                        Intent intent = new Intent();
//                        intent.putExtra(JsMethodAdapter.CODE, resultZxing);
//                        setResult(RESULT_OK, intent);
//                        finish();
//                    } else {
//                        Toast.makeText(getApplicationContext(), getString(R.string.error_barcode), Toast.LENGTH_SHORT).show();
//                    }
//                }
//            }
//        }
